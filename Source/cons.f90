...
INTEGER, PARAMETER :: SPHERE_DRAG=1,CYLINDER_DRAG=2,USER_DRAG=3,SCREEN_DRAG=4,POROUS_DRAG=5,BUNDLE_DRAG=6 ! Options for drag computation
...
LOGICAL :: LES,DNS,RADIATION=.TRUE.,RADIATION_COMPLETED=.TRUE.,EXCHANGE_RADIATION=.FALSE.,KAPPA_ARRAY=.FALSE.,CYLINDRICAL,NOISE, &
           ...
           NEW_MOMENTUM_NUDGING=.FALSE.,CORRECT_SUBGRID_TEMPERATURE=.FALSE.,NEW_PART_KAPPA=.FALSE.
